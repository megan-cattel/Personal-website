        ...
        <div>
            ...
            <div className="row justify-content-center p-3">
                <div className="col col-12 col-md-8 article">
                    ...
                    <p className="small">Below are audio stories I helped produce for WBUR and Foreign Policy. I cut tape, booked guests, contacted fixers, found archival sound, and went out into the field to record interviews.</p>
                    <ul>
                        <li>
            ...
            <div className="row justify-content-center p-3">
                <div className="col col-12 col-md-8 article">
                    ...
                    <p className="small">Since August 2021, I’ve been head editor of the <a href="https://nuvoices.com/">NüVoices</a> podcast, a show which elevates marginalized genders who publish work about China. We regularly platform journalists, diplomats, academics, writers, and artists from around the world to diversify English-language points of view on China, Taiwan, and Hong Kong. To date, I’ve produced and edited over 20 episodes for this biweekly podcast series. I also book guests, prep our team of hosts, and offer tech support over Riverside FM whenever needed. Mostly, I edit down the podcast and cut tape in Adobe Audition. Occasionally, I also host episodes! (Scroll down to learn more.) </p>
                    <iframe id="player_iframe" src="https://www.buzzsprout.com/1858406?client_source=large_player&iframe=true&referrer=https%3A%2F%2Fwww.buzzsprout.com%2F1858406%2Fpodcast%2Fembed" loading="lazy" width="100%" height="375" frameborder="0" scrolling="no" title="NüVoices"></iframe>
                </div>
            </div>
            <div className="row justify-content-center p-3">
                <div className="col col-12 col-md-8 article">
                    <div className="article-title">
                        <p><b><i>On the Mic</i></b></p>
                    </div>
                    <p className="small">One of the reasons why I fell in love with audio: I listened to Terry Gross on <i>Fresh Air</i> religiously as a kid! While I mostly do podcast production work, I also go behind the mic and host episodes too. Below are some of my favorites.</p>
                    <ul>
                        <li>
            ...
            <div className="row justify-content-center p-3">
                <div className="col col-12 col-md-8 article">
                    ...
                    <p className="small">I pitched, reported, and produced the following stories for Uptown Radio, Columbia Journalism School’s weekly newsmagazine show.</p>
                    <ul>
                        <li>
