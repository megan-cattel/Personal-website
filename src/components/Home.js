            ...
            <div className="col col-12 col-md-8 home align-items-center my-auto">
                ...
                <div className="text-left">
                  <div className="intro-home">
                    ...
                    <p className="p-2">↳ I serve as board member and head podcast editor at <a href="https://nuvoices.com/">NüVoices</a>, a collective which supports marginalized genders publishing work about China, Taiwan, and Hong Kong.</p>
