            ...
            <div className="col col-12 col-md-8 home align-items-center my-auto">
                ...
                <div className="text-left">
                  <div className="intro-home">
                    <p className="p-2"><b><span className="intro-red">Hi, I’m <a href={process.env.PUBLIC_URL + "/#/about"}>Megan</a></span>, a freelance journalist and audio producer based in Tampa, FL & NYC.</b></p>
